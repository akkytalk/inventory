                                  ...
                                  (product, index) => {
                                    let obj = productdata.find((o, i) => {
                                      if (
                                        ...
                                        product.bill_rate = o.sale_rate;
                                        product.gst_rate = o.gst_rate;
                                        var bill_rate = Number(
                                          product.bill_rate
                                        );
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(EditDelivery)
);
